...
export const metadata: Metadata = {
  title: 'Why Every Beauty Professional Needs a Budget (And How to Start) - TipJars',
  description: 'Traditional budgets fail beauty professionals because they assume steady paychecks. Learn how jar-based budgeting works for irregular income.',
}
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-8">Why Every Beauty Professional Needs a Budget (And How to Start)</h1>
        
        <div className="prose prose-invert prose-zinc max-w-none space-y-6 text-zinc-300 leading-relaxed">
          <p>If the word &ldquo;budget&rdquo; makes you cringe, you&apos;re not alone. Most barbers, stylists, nail techs, and independent beauty professionals have tried budgeting at some point &mdash; maybe a spreadsheet, maybe an app designed for people with biweekly paychecks &mdash; and it felt pointless. That&apos;s not because budgeting doesn&apos;t work. It&apos;s because the wrong kind of budget doesn&apos;t work for you.</p>

          <h2 className="text-xl font-bold text-zinc-100 mt-8">Why Traditional Budgets Fail Beauty Pros</h2>
          ...
          <p>Instead of planning around a fixed monthly income, the jar system works on percentages. Every time money comes in &mdash; whether it&apos;s $20 or $200 &mdash; it gets split the same way. A recommended split:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>Essentials (50%)</strong> &mdash; Booth rent, chair rent, station rent, supplies, food, bills, transportation</li>
            ...
            <li><strong>Fun (10%)</strong> &mdash; Going out, new gear, whatever makes you happy</li>
          </ul>
          ...
          <p>The biggest thing a budget gives you isn&apos;t more money &mdash; it&apos;s less stress. When you know taxes are covered, rent is handled, and savings are growing, you can focus on what you actually love: your craft. You show up to the chair, the station, or the booth with a clear head instead of a gnawing worry about bills.</p>
