...
export const metadata: Metadata = {
  title: 'Tax Tips Every Beauty Professional Should Know - TipJars',
  description: 'Essential tax advice for self-employed stylists, barbers, nail techs, tattoo artists, and independent beauty professionals. Deductions, estimated payments, and how to avoid surprises.',
}
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-8">Tax Tips Every Beauty Professional Should Know</h1>
        
        <div className="prose prose-invert prose-zinc max-w-none space-y-6 text-zinc-300 leading-relaxed">
          <p>Taxes are the thing nobody wants to talk about in the beauty industry. But if you&apos;re a stylist, barber, nail tech, lash artist, tattoo artist, or any independent beauty professional, understanding your taxes is the difference between keeping your hard-earned money and giving the IRS a surprise bonus.</p>
          ...
          <p>As a self-employed beauty professional, you can deduct legitimate business expenses from your income before calculating taxes. Common deductions include:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>Booth, chair, or station rent</strong> &mdash; Your biggest expense and fully deductible</li>
            <li><strong>Tools and supplies</strong> &mdash; Clippers, shears, combs, nail kits, tattoo equipment, capes, cleaning supplies</li>
            <li><strong>Product costs</strong> &mdash; Anything you use on clients or sell</li>
            <li><strong>Continuing education</strong> &mdash; Classes, workshops, certifications, licensing renewals</li>
          ...
          <p>A good tax professional who understands self-employment can save you way more than they cost. Ask other professionals in your area for recommendations. Many offer flat-rate pricing for simple self-employment returns.</p>
